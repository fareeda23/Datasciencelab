...
<head>
    ...
    <style>
        ...
        .card {
            height: 100%; /* Ensure the cards take up the same height */
        }
    </style>
</head>
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="add_announcement.php"></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_announcements.php"></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row mt-5">
            <div class="col-md-4">
                <div class="card text-bg-primary mb-3 h-100">
                    <div class="card-body">
                        <h5 class="card-title">Add & View Announcement</h5>
